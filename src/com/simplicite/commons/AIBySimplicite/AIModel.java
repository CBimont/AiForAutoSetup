...
public class AIModel implements java.io.Serializable {
	...
	public static JSONObject createModule(String name,String prefix,String login,Grant g) {
		...
		translateDomFlds.put("tsl_value",name);
		AITools.createOrUpdateWithJson("TranslateDomain",translateDomFlds,g);
		translateDomFlds.put("tsl_lang",Globals.LANG_ENGLISH);
		AITools.createOrUpdateWithJson("TranslateDomain",translateDomFlds,g);
		//Scope
		JSONObject scopeFlds = new JSONObject();
		scopeFlds.put("row_module_id",mldId);
		scopeFlds.put("viw_name","Scope"+name);
		scopeFlds.put("viw_type","H");
		String scopeId = AITools.createOrUpdateWithJson("View",scopeFlds,g);
		// translate scope
		...
		translateScopeFlds.put("tsl_value","Scope "+name);
		AITools.createOrUpdateWithJson("TranslateView",translateScopeFlds,g);
